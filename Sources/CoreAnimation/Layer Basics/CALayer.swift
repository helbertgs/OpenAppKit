...
open class CALayer {
    ...
    public var contentsCenter: CoreGraphics.CGRect = .init(x: 0, y: 0, width: 1, height: 1)
    ...
    open func draw(in context: CoreGraphics.CGContext) {
        fatalError("not implemented yet")
    }
    ...
    public var shadowOffset: CoreGraphics.CGSize = .init(width: 0, height: -3)

    /// The color of the layer’s shadow.
    /// 
    /// The default value of this property is an opaque black color.
    public var shadowColor: CoreGraphics.CGColor? = .black
    ...
    public var frame: CoreGraphics.CGRect = .zero
    ...
    /// The values of each coordinate in the rectangle are measured in points.
    public var bounds: CoreGraphics.CGRect = .zero
    ...
    public var position: CoreGraphics.CGPoint = .zero
    ...
    public var anchorPoint: CoreGraphics.CGPoint = .init(x: 0.5, y: 0.5)
    ...
    public func affineTransform() -> CGAffineTransform {
        .init()
    }
    ...
    public func setAffineTransform(_ m: CGAffineTransform) {
        fatalError("not implemented yet")
    }
    ...
    public func setNeedsDisplay(_ rect: CoreGraphics.CGRect) {
        fatalError("not implemented yet")
    }
    ...
    public func resize(withOldSuperlayerSize size: CoreGraphics.CGSize) {
        fatalError("not implemented yet")
    }
    ...
    public func resizeSublayers(withOldSize size: CoreGraphics.CGSize) {
        fatalError("not implemented yet")
    }
    ...
    public func preferredFrameSize() -> CoreGraphics.CGSize {
        fatalError("not implemented yet")
    }
    ...
    public func convert(_ point: CoreGraphics.CGPoint, from layer: CALayer?) -> CoreGraphics.CGPoint {
        fatalError("not implemented yet")
    }
    ...
    public func convert(_ point: CoreGraphics.CGPoint, to layer: CALayer?) -> CoreGraphics.CGPoint {
        fatalError("not implemented yet")
    }
    ...
    public func convert(_ rect: CoreGraphics.CGRect, from layer: CALayer?) -> CoreGraphics.CGRect {
        fatalError("not implemented yet")
    }
    ...
    public func convert(_ rect: CoreGraphics.CGRect, to layer: CALayer?) -> CoreGraphics.CGRect {
        fatalError("not implemented yet")
    }
    ...
    public func hitTest(_ point: CoreGraphics.CGPoint) -> CALayer? {
        fatalError("not implemented yet")
    }
    ...
    public func contains(_ point: CoreGraphics.CGPoint) -> Bool {
        fatalError("not implemented yet")
    }
    ...
    public var visibleRect: CoreGraphics.CGRect = .init()
    ...
    public func scroll(_ point: CoreGraphics.CGPoint) {
        fatalError("not implemented yet")
    }
    ...
    public func scrollRectToVisible(_ rect: CoreGraphics.CGRect) {
        fatalError("not implemented yet")
    }
