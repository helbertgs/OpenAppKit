...
/// Express these values with a single size data type (``CGSize`` in iOS, ``OpenCoreGraphics.CGSize`` in macOS), using the units of the default user coordinate space. 
...
@MainActor public class NSShadow: @preconcurrency Equatable, @preconcurrency Hashable {
    ...
    /// 
    /// This property contains the horizontal and vertical offset values that you specify using the width and height fields of the ``CGSize`` or ``OpenCoreGraphics.CGSize`` data type. 
    ...
    public var shadowOffset: OpenCoreGraphics.CGSize
    ...
    public init(shadowOffset: OpenCoreGraphics.CGSize, shadowBlurRadius: Float = 0, shadowColor: NSColor = NSColor(red: 0, green: 0, blue: 0, alpha: 0.33)) {
